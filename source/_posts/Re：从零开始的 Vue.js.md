...
![vue_first](https://img.nekolr.com/images/2018/04/14/QnV.png)
...
![proxy_data](https://img.nekolr.com/images/2018/04/14/qx0.png)
		
只有被代理的属性是响应的，在 Vue 实例创建后添加的新属性不具有响应特性。
		
除了 data 属性，Vue 实例还暴露了一些实例属性和方法（带有 $ 前缀标识）。
		
![vue_$](https://img.nekolr.com/images/2018/04/14/vp8.png)
...
<img alt="life_cycle" src="https://img.nekolr.com/images/2018/04/14/W03.png
" style="height:65%;width:65%;" />
		
Vue 实例在被创建之前要执行一系列的初始化过程，在这个过程中也可以调用一些生命周期钩子，这使得我们可以执行一些自定义的逻辑。
		
![life_cycle_hook](https://img.nekolr.com/images/2018/04/14/jzP.png)
...
![cmline_param1](https://img.nekolr.com/images/2018/04/14/VO9.png)
		
![cmline_param2](https://img.nekolr.com/images/2018/04/14/gam.png)
		
#### 后缀
指令可以使用“.”指定一个特殊的后缀，表示这个指令以特殊的方式绑定。
		
![cmline_teshu](https://img.nekolr.com/images/2018/04/14/7dl.png)
...
![filter](https://img.nekolr.com/images/2018/04/14/6pL.png)
		
#### 串联
过滤器可以串联。表达式的值作为参数传给第一个过滤器函数，计算后再将结果作为参数传给第二个过滤器函数。
		
![chuanlian](https://img.nekolr.com/images/2018/04/14/2nw.png)
		
#### 接收参数
过滤器可以接收参数。
		
![filter_param](https://img.nekolr.com/images/2018/04/14/m6K.png)
		
### 语法糖
有更简洁的使用 `v-bind` 和 `v-on` 语法。
		
![v-bind_sweet](https://img.nekolr.com/images/2018/04/14/D4w.png)
		
![v-on_sweet](https://img.nekolr.com/images/2018/04/14/MBp.png)
...
![computed](https://img.nekolr.com/images/2018/04/14/wNX.png)
		
### setter
计算属性设置的方法，默认就是一个 get 方法，我们还可以添加 set 方法。
		
![setter](https://img.nekolr.com/images/2018/04/14/3gn.png)
		
### watch
Vue.js 提供了一个更为通用的观察 Vue 实例数据发生变化的属性 `watch`。当你希望数据变化时执行异步操作或者大量计算时很有用。
		
![watch](https://img.nekolr.com/images/2018/04/14/oo8.png)
